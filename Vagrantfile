Vagrant.configure(2) do |config|
  ...
  config.vm.define :mm1 do |mm1|
    ...
    mm1.vm.network :public_network, bridge: 'en0: Ethernet', ip: "192.168.1.111"
  end
  ...
  config.vm.define :mm2 do |mm2|
    ...
    mm2.vm.network :public_network, bridge: 'en0: Ethernet', ip: "192.168.1.112"
  end
  ...
  config.vm.define :mm3 do |mm3|
    ...
    mm3.vm.network :public_network, bridge: 'en0: Ethernet', ip: "192.168.1.113"
  end
  ...
  config.vm.define :ms1 do |ms1|
    ...
    ms1.vm.network :public_network, bridge: 'en0: Ethernet', ip: "192.168.1.114"
  end
  ...
  config.vm.define :ms2 do |ms2|
    ...
    ms2.vm.network :public_network, bridge: 'en0: Ethernet', ip: "192.168.1.115"
  end
  ...
  config.vm.define :ms3 do |ms3|
    ...
    ms3.vm.network :public_network, bridge: 'en0: Ethernet', ip: "192.168.1.116"
  end
  ...
  config.vm.define :registry do |registry|
    ...
    registry.vm.network :public_network, bridge: 'en0: Ethernet', ip: "192.168.1.119"
  end
